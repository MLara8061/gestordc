<template>
        ...
        <div class="py-12">
          ...
          <div class="mt-3 mb-3 flex">
           <PrimaryButton @click="$event => openModal(1)">
            <i class="fa-solid fa-plus-cirlce"></i> Agregar
           </PrimaryButton>
       </div>
    </div>
    </div>
    ...
    <Modal :show="modal" @close="closeModal">
       ...
       <div class="p-3">
        ...
        v-model="form.name" type="text" class="mt-1 lock w-3/4"
       ...
       <div class="p-3">
        ...
        <TextInput id="email" 
        v-model="form.email" type="text" class="mt-1 lock w-3/4"
       ...
       <div class="p-3">
        ...
        <TextInput id="phone" 
        v-model="form.phone" type="text" class="mt-1 lock w-3/4"
       ...
       <div class="p-3">
        ...
        v-model="form.department_id" type="text" class="mt-1 lock w-3/4"></SelectInput>
...
const save = () =>{
    if(operation.value == 1){
        form.post(route('employees.store'),{
           onSuccess: () => {ok('Contacto Guardado')}
        });
    }
    else{
