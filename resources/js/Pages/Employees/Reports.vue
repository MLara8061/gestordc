...
buttons1.value= [
    {
        ...
        className:'rounded-md bg-green-600 px-4 py-2 text-center text-sm text-white hover:bg-green-500'
    },
    {
    ...
    },
    {
        ...
        className:'rounded-md bg-indigo-600 px-4 py-2 text-center text-sm text-white hover:bg-indigo-500'
    },
    {
    ...
    <AuthenticatedLayout>
      ...
      <div class="py-10">
        <div class=" mx-auto sm:px-6 lg:px-8">
            ...
            <div v-else="report == '1' " class="px-6 py-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
